var extendedJSON = (function(){
    ...
    out.encode = function(obj, encodeAll, path, symbol){
        path = path||"root";
        ...
        if(obj === null || obj === undefined){
            ...
            for(var i=0; i<keys.length; i++){
                ...
                try{
                    ...
                    if(descriptor && descriptor.value) o = descriptor.value;
                    else if(descriptor && descriptor.get) o = descriptor.get.call(obj);
                    else o = obj[key];
                    ...
                    if(p!=null && (s=Object.getOwnPropertyDescriptor(o, out.convertingSymbol)) && s.value==symbol){
                        ...
                        ret.properties[index++] = [key, out.encode(o, encodeAll, path+"."+key, symbol)];
                    }
